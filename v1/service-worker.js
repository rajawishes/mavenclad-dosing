...
self.addEventListener("install", function(event) {
    ...
    */
    event.waitUntil(
        ...
        */
        .open(version + 'offlinedosing')
        .then(function(cache) {
            /* After the cache is opened, we can fill it with the offline fundamentals.
               The method below will add all resources in `offlinedosing` to the
               cache, after making requests for them.
            */
            return cache.addAll(offlinedosing);
        })
        .then(function() {
...
event.respondWith(
    ...
    */
    ...
    /* When this method is called, it means we were unable to produce a response
       from either the cache. This is our opportunity to produce
    ...
    */
    function unableToResolve() {
        /* There's a couple of things we can do here.
           - Test the Accept header and then return one of the `offlinedosing`
